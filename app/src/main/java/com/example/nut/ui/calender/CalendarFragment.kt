...
class CalendarFragment : Fragment() {
    ...
    private fun initData() {
        ...
        map.put(getSchemeCalendar(year, month, 15, 0x895439, "化学模拟").toString(),
                getSchemeCalendar(year, month, 15, 0x895439, "化学模拟"))
        map.put(getSchemeCalendar(year, month, 18, 0x3700B3, "小周生日").toString(),
                getSchemeCalendar(year, month, 18, 0x3700B3, "小周生日"))
        map.put(getSchemeCalendar(year, month, 18, 0x895439, "英语PRE").toString(),
                getSchemeCalendar(year, month, 18, 0x895439, "英语PRE"))
